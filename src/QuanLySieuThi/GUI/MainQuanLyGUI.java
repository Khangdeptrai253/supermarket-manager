...
import QuanLySieuThi.BUS.PhanQuyenBUS;
import QuanLySieuThi.DTO.PhanQuyen;
...
public class MainQuanLyGUI extends JFrame {
    ...
    public MainQuanLyGUI() {
        this.setTitle("PHẦN MỀM QUẢN LÝ SIÊU THỊ");
    ...
    private void addControls() {
        ...
        JLabel lblTitleText = new JLabel(new ImageIcon("image/ManagerUI/title.jpg"));
        ...
        JLabel lblAvatar = new JLabel(new ImageIcon("image/ManagerUI/supermarket.jpg"), JLabel.CENTER);
